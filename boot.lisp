...
(defconstant *inka-lisp*
              ...
              #+LISPWORKS                    'LUCID
	      #+CMU                          'CMU
	      #-(OR ALLEGRO LISPWORKS CMU)   'UNKNOWN
	      )
...
(defconstant *inka-binary-file-type*
  (cond ((eq *inka-lisp* 'ALLEGRO) "fasl")
	((eq *inka-lisp* 'LUCID) "ufsl")
	((eq *inka-lisp* 'CMU) "x86f")
	(t "bin")))
...
(defconstant *inka-files* 
		 ...
		 #+allegro "process_acl"
		 #+CMU "process_cmu"
		 #+CMU "window_manager_tcl_cmu"
		 #-CMU "window_manager_tcl"
		 "service"
		 "datastructure"
		 "unification"
		 "print"
